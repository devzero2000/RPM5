...
/** \ingroup rpmio
 */
typedef /*@refcounted@*/ struct rpmmgo_s * rpmmgo;

/** \ingroup rpmgo
 */
/*@unchecked@*/
extern int _rpmmgo_debug;

/*@unchecked@*/ /*@relnull@*/
extern rpmmgo _rpmmgoI;
 ...
 */
/*@unused@*/ /*@null@*/
rpmmgo rpmmgoUnlink (/*@killref@*/ /*@only@*/ /*@null@*/ rpmmgo mgo)
	/*@modifies mgo @*/;
#define	rpmmgoUnlink(_mgo)	\
    ((rpmmgo)rpmioUnlinkPoolItem((rpmioItem)(_mgo), __FUNCTION__, __FILE__, __LINE__))
 ...
 */
/*@unused@*/ /*@newref@*/ /*@null@*/
rpmmgo rpmmgoLink (/*@null@*/ rpmmgo mgo)
	/*@modifies mgo @*/;
#define	rpmmgoLink(_mgo)	\
    ((rpmmgo)rpmioLinkPoolItem((rpmioItem)(_mgo), __FUNCTION__, __FILE__, __LINE__))
 ...
 */
/*@null@*/
rpmmgo rpmmgoFree(/*@killref@*/ /*@null@*/rpmmgo mgo)
	/*@globals fileSystem @*/
	/*@modifies mgo, fileSystem @*/;
#define	rpmmgoFree(_mgo)	\
    ((rpmmgo)rpmioFreePoolItem((rpmioItem)(_mgo), __FUNCTION__, __FILE__, __LINE__))
