...
const hashFunction cubehash256 = {
    .name = "CUBEHASH-256",
    .paramsize = sizeof(cubehashParam),
    .blocksize = 64,
    .digestsize = 256/8,        /* XXX default to CUBEHASH-256 */
    .reset = (hashFunctionReset) cubehashReset,
    .update = (hashFunctionUpdate) cubehashUpdate,
    .digest = (hashFunctionDigest) cubehashDigest
};
