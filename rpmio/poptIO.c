...
struct poptOption rpmioDigestPoptTable[] = {
 ...
 { "skein256",'\0', POPT_ARG_VAL, &rpmioDigestHashAlgo, PGPHASHALGO_SKEIN256,
	N_("SKEIN-256 digest"), NULL },
 { "skein512",'\0', POPT_ARG_VAL, &rpmioDigestHashAlgo, PGPHASHALGO_SKEIN512,
	N_("SSKEIN-512 digest"), NULL },
 { "skein1024",'\0', POPT_ARG_VAL, &rpmioDigestHashAlgo, PGPHASHALGO_SKEIN1024,
	N_("SKEIN-1024 digest"), NULL },
 { "edonr",'\0', POPT_ARG_VAL, &rpmioDigestHashAlgo, PGPHASHALGO_EDONR,
