...
/*!\addtogroup HASH_rmd256_m
 * \{
 */

/*@unchecked@*/ /*@observer@*/
static uint32_t rmd256hinit[8] = {
...
/*@-sizeoftype@*/
/*@unchecked@*/ /*@observer@*/
const hashFunction rmd256 = {
	"RIPEMD-256",
	sizeof(rmd256Param),
	64,
	256/8,
	(hashFunctionReset) rmd256Reset,
	(hashFunctionUpdate) rmd256Update,
	(hashFunctionDigest) rmd256Digest
};
/*@=sizeoftype@*/

int rmd256Reset(register rmd256Param* mp)
{
/*@-sizeoftype@*/
	memcpy(mp->h, rmd256hinit, 8 * sizeof(uint32_t));
...
static void rmd256Finish(rmd256Param* mp)
	/*@modifies mp @*/
{
...
/*@-protoparammatch@*/
int rmd256Digest(rmd256Param* mp, byte* data)
{
	rmd256Finish(mp);
