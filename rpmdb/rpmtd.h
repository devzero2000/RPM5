...
/** \ingroup rpmtd
 * Return uint8_t data from tag container.
...
typedef enum rpmtdFormats_e {
    ...
    RPMTD_FORMAT_DEPFLAGS	=  4,	/* dependency flags (uint types) */
    RPMTD_FORMAT_FFLAGS		=  5,	/* file flags (uint types) */
    RPMTD_FORMAT_PERMS		=  6,	/* permission string (uint types) */
    RPMTD_FORMAT_TRIGGERTYPE	=  7,	/* trigger types (uint types) */
    RPMTD_FORMAT_XML		=  8,	/* xml format (any type) */
    RPMTD_FORMAT_OCTAL		=  9,	/* octal format (uint types) */
    RPMTD_FORMAT_HEX		= 10,	/* hex format (uint types) */
    RPMTD_FORMAT_DATE		= 11,	/* date format (uint types) */
    RPMTD_FORMAT_DAY		= 12,	/* day format (uint types) */
    RPMTD_FORMAT_SHESCAPE	= 13,	/* shell escaped (any type) */
    RPMTD_FORMAT_ARRAYSIZE	= 14,	/* size of contained array (any type) */
    RPMTD_FORMAT_DEPTYPE	= 15,	/* dependency types (uint types) */
    RPMTD_FORMAT_FSTATE		= 16,	/* file states (uint types) */
    RPMTD_FORMAT_VFLAGS		= 17,	/* file verify flags (uint types) */
} rpmtdFormats;
