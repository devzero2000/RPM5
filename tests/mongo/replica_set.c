...
int test_connect( const char * test_server, const char *set_name ) {
...
int test_reconnect( const char * test_server, const char *set_name ) {
...
int main(int argc, char *argv[])
{
    ...
    ASSERT( test_connect( test_server, "test-rs" ) == MONGO_OK );
    ASSERT( test_connect( test_server, "test-foobar" ) == MONGO_CONN_BAD_SET_NAME );
