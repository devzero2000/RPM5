...
static struct poptOption optionsTable[] = {
 { "debug", 'd', POPT_ARG_VAL|POPT_ARGFLAG_DOC_HIDDEN,		&_debug, 1,
  ...
  { "search", '\0', POPT_ARG_MAINCALL,	rpmkeySearch, 0,
	N_("X"), N_("<keyring> <type> <desc> [<dest_keyring>]") },
